...
export default function ClientDashboard() {
  ...
  const handleStatClick = (stat) => {
    if (stat.filterKey) {
      router.push(
        `/cleaner-review?companyId=${companyId}&status=${stat.filterKey}`,
      );
      ...
      <div className="flex flex-col justify-center items-center h-94 bg-slate-50">
        <div className="text-center p-8 bg-white rounded-xl shadow-sm max-w-md">
          ...
          <p className="text-slate-500">
            You don't have permission to view dashboard statistics. Please
                    ...
                    {recentActivities.map((activity) => (
                      ...
                      >
                        <div className="flex-shrink-0 mt-1">
                          <div
                            className={`w-8 h-8 rounded-full ${activityColors[activity.activityType]} flex items-center justify-center text-white`}
                          >
